class Validator {
  ...
  static String? folderName(String? str) {
    if (str == null || str.isEmpty) {
      return "• Boş bırakılamaz";
    }
    ...
    if (str.length > 20) {
      return "• En fazla 20 karaktere izin verilir.";
    }
    return null;
  }

  static String? documentNo(String? str) {
    if (str == null || str.isEmpty) {
      return "• Boş bırakılamaz";
    }
    if (str.replaceAll(" ", "").isEmpty) {
    ...
    if (str.contains("-")) {
      return "• Geçerli karakter giriniz.'-' (çizgi) bulunduramazsınız.";
    }
    if (str.length > 20) {
      return "• En fazla 20 karaktere izin verilir.";
    }
  ...
  static String? storeNotNull(String? str) {
    if (str == null || str.isEmpty) {
      return "• Boş bırakılamaz";
    }
    if (str.replaceAll(" ", "").isEmpty) {
    ...
    if (str.length < 3) {
      return "• En az 3 karakter girilmesi gerekmektedir.";
    }
    return null;
  }

  static String? storeCode(String? str) {
    if (str == null || str.isEmpty) {
      return "• Lütfen mağaza kodu alanını doldurunuz.";
    } else if (str.length != 4) {
      return "• Lütfen geçerli bir kod giriniz.";
    } else if (int.tryParse(str).toString().length != 4) {
      return "• Lütfen geçerli bir kod giriniz.";
    }
    return null;
  }
